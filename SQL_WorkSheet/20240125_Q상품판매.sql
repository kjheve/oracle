...
INSERT INTO ORDERS (order_id, customer_id, orderdate, status)
      VALUES (1, 1, TO_DATE('2024/1/1', 'YYYY/MM/DD'), 'PENDING');
INSERT INTO ORDERS (order_id, customer_id, orderdate, status)
      VALUES (2, 1, TO_DATE('2024/1/2', 'YYYY/MM/DD'), 'PENDING');
INSERT INTO ORDERS (order_id, customer_id, orderdate, status)
      VALUES (3, 2, TO_DATE('2024/1/1', 'YYYY/MM/DD'), 'COMPLETED');
INSERT INTO ORDERS (order_id, customer_id, orderdate, status)
      VALUES (4, 2, TO_DATE('2024/1/2', 'YYYY/MM/DD'), 'CANCELLED');
INSERT INTO ORDERS (order_id, customer_id, orderdate, status)
      VALUES (5, 2, TO_DATE('2024/1/3', 'YYYY/MM/DD'), 'PENDING');
...
INSERT INTO ORDERDETAILS (orderdetail_id, order_id, product_id, quantity, price)
      VALUES (1, 1, 1, 1, 1000000);
INSERT INTO ORDERDETAILS (orderdetail_id, order_id, product_id, quantity, price)
      VALUES (2, 2, 1, 1, 1000000);
INSERT INTO ORDERDETAILS (orderdetail_id, order_id, product_id, quantity, price)
      VALUES (3, 2, 2, 1, 500000);
INSERT INTO ORDERDETAILS (orderdetail_id, order_id, product_id, quantity, price)
      VALUES (4, 3, 3, 1, 30000);
INSERT INTO ORDERDETAILS (orderdetail_id, order_id, product_id, quantity, price)
      VALUES (5, 4, 4, 1, 100000);
INSERT INTO ORDERDETAILS (orderdetail_id, order_id, product_id, quantity, price)
      VALUES (6, 5, 5, 1, 400000);
